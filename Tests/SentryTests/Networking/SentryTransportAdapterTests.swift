...
class SentryTransportAdapterTests: XCTestCase {
    ...
    private static let dsnAsString = TestConstants.dsnAsString(username: "SentryTransportAdapterTests")
    private static let dsn = TestConstants.dsn(username: "SentryTransportAdapterTests")
    ...
    private class Fixture {
        ...
        init() {
            ...
            options = Options()
            options.dsn = SentryTransportAdapterTests.dsnAsString
    ...
    class func buildRequest(_ envelope: SentryEnvelope) -> SentryNSURLRequest {
        ...
        return try! SentryNSURLRequest(envelopeRequestWith: SentryTransportAdapterTests.dsn, andData: envelopeData)
    }
    ...
    func testActiveRateLimitForSomeCachedEnvelopeItems() {
        ...
        let sessionRequest = try! SentryNSURLRequest(envelopeRequestWith: SentryTransportAdapterTests.dsn, andData: sessionData)
